...
const PublishForm = () => {
  ...
  let {setEditorState,setBlog }= useContext(EditorContext);
  let characterLimit=200;// char. limit
  let tagLimit=10;// tag limit

  let {blog,blog:{title ,banner, tags, des,content, author}} =useContext(EditorContext);
  ...
  const publishBlog=(e)=>{
    ...
    if(!des.length || des.length>characterLimit) return toast.error(`Write the description within ${characterLimit}`);
        ...
        <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
           <Toaster/>
            ...
            <div className="max-w-[550px] center">
              ...
              <p className="font-gelasio line-clamp-2 mt-4 leading-7 text-xl">{ des }</p>
            </div>
            ...
            <div className="border-grey lg:border-1 lg:pl-8">
              ...
              <textarea maxLength={characterLimit} defaultValue={des}
               ...
               onChange={handleBlogDescription} onKeyDown={handleTitleKeyDown}>
              </textarea>
